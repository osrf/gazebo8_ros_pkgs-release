## gazebo8_ros_pkgs (lunar) - 2.7.6-0

The packages in the `gazebo8_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar gazebo8_ros_pkgs` on `Mon, 15 Oct 2018 10:58:02 -0000`
...
## gazebo8_ros_pkgs (kinetic) - 2.5.17-1

The packages in the `gazebo8_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic gazebo8_ros_pkgs` on `Mon, 15 Oct 2018 10:11:06 -0000`
...
## gazebo8_ros_pkgs (kinetic) - 2.5.17-0

The packages in the `gazebo8_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic gazebo8_ros_pkgs` on `Mon, 15 Oct 2018 10:00:21 -0000`
...
## gazebo8_ros_pkgs (kinetic) - 2.5.14-2

The packages in the `gazebo8_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo8_ros_pkgs --edit` on `Sun, 14 Jan 2018 23:56:47 -0000`
...
## gazebo8_ros_pkgs (kinetic) - 2.5.14-1

The packages in the `gazebo8_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo8_ros_pkgs --edit` on `Sun, 14 Jan 2018 21:05:35 -0000`
...
## gazebo8_ros_pkgs (lunar) - 2.7.2-0

The packages in the `gazebo8_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --track lunar --ros-distro lunar gazebo8_ros_pkgs --edit` on `Tue, 06 Jun 2017 22:15:27 -0000`
...
## gazebo8_ros_pkgs (kinetic) - 2.5.10-1

The packages in the `gazebo8_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo8_ros_pkgs --edit` on `Thu, 23 Mar 2017 01:33:53 -0000`
